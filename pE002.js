...
/**
 * * Suma todos los números pares en la secuencia de Fibonacci que 
 * * son menores a 4 millones.
 * 
 * * La secuencia de Fibonacci es una serie de números donde cada 
 * * número es la suma de los dos números anteriores. Los dos 
 * * primeros números son 0 y 1.
 * 
 ...
 * ?  =>  0, 2, 8, 34
 * 
 * * La suma de los primeros diez números pares en la sucesión de 
 * * Fibonacci es:
 * ?  =>  0 + 2 + 8 + 34 = 44
 * 
 * * La suma de los primeros diez números pares en la sucesión de 
